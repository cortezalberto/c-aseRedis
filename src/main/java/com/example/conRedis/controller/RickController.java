...
public class RickController {
    ...
    public ResponseEntity<?> get(@PathVariable("id") Integer id){
        ...
        System.out.println("Busco el personaje :"  +id+ " reviso la caché primero");
        ...
        try {
            ...
            System.out.println(" La data del valor en la cache : " + data);
            ...
            if(response.getStatusCodeValue() == 200) {
                ...
                valueOp.set(getKey(id.toString()), response.getBody() , Duration.ofSeconds(20));
            }
